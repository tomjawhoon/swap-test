...
const main = async () => {
    ...
    const MKRWETHPair = await Fetcher.fetchPairData(DAI, WETH[chainId]);
    ...
    // console.log("show clin =>>>",trade.executionPrice.toSignificant())

    console.log(`Trade ${amount} ETH to ` + trade.executionPrice.toSignificant(6) + ` DAI`);
